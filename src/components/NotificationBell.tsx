    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <>
          ...
          <div className="fixed left-3 right-3 top-16 z-50 sm:absolute sm:right-auto sm:left-0 sm:top-12 sm:w-96 sm:max-h-[calc(100vh-5rem)] rounded-xl border border-border bg-card shadow-xl animate-fade-in overflow-hidden">
