...
const features = [
  ...
  },
  {
    icon: Eye,
    title: "Watchlists",
    tagline: "Track 4,800+ stocks, ETFs, index funds and crypto assets",
    details: [
      "Track 4,800+ stocks, ETFs, index funds and crypto assets in real time with live prices, charts and AI analysis.",
      ...
      <RevealSection>
        <div className="border-y border-border bg-card/50 py-8 px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { value: "4,800+", label: "Stocks, ETFs, Index Funds & Crypto", icon: BarChart3 },
