...
const features = [
  ...
  },
  {
    icon: Eye,
    title: "Watchlists",
    tagline: "Track 1500+ stocks, ETFs and crypto assets",
    details: [
      "Track 1500+ stocks, ETFs and crypto assets in real time with live prices, charts and AI analysis.",
      ...
      <RevealSection>
        <div className="border-y border-border bg-card/50 py-8 px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { value: "1500+", label: "Stocks, ETFs & Crypto", icon: BarChart3 },
