...
const features = [
  ...
  },
  {
    icon: Eye,
    title: "Watchlists",
    tagline: "Track 5,500+ stocks, ETFs, index funds and crypto from 20+ countries",
    details: [
      "Track 5,500+ stocks, ETFs, index funds and crypto assets from global markets in real time with live prices, charts and AI analysis.",
      ...
      <RevealSection>
        <div className="border-y border-border bg-card/50 py-8 px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { value: "5,500+", label: "Global Stocks, ETFs & Crypto", icon: BarChart3 },
